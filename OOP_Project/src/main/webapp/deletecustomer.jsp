...
<center>	<h2>Delivery Account Delete</h2>   </center>
	...
	<table>
		<tr>
			...
			<td><input type="text" name="deliveryID"  value="<%= deliveryID %>" readonly></td>
		</tr>
		...
		<tr>
			<td> <b> Province </b> </td>
			<td><input type="text" name="province" value="<%= province %>" readonly></td>
		</tr>
